...
//                {4, 62, 98, 27, 23, 9, 70, 98, 73, 93, 38, 53, 60, 04, 23}
        ...
        breakAndSumTree(tree);
    }

    public void breakAndSumTree(int[][] tree){
        for(int i=tree.length-1; i > 0; i--){
            for(int j = 1; j<tree[i].length; j++){
                ...
                int parent = tree[i-1][j-1];
                System.out.println("Parent: "+parent);
                System.out.println("Children: "+a+", "+b);

                tree[i-1][j-1] = parent+a>parent+b ? parent+a : parent+b;

            }
                System.out.println("_______________END ROW_____________________");
        }
    }
